...
public class StatusUtils {
    ...
    static {
        ...
        statusMap.put(9003, R.string.extra_launcher);
        statusMap.put(9004, R.string.extra_input_method);
        statusMap.put(9001, R.string.extra_audio_focused);
        statusMap.put(9002, R.string.extra_vpn_established);
    }
