...
public class Configuration {
    ...
    public boolean optimizeAudio() {
        return bundle.getBoolean(PreventIntent.KEY_OPTIMIZE_AUDIO, false);
    }

    public boolean optimizeVpn() {
        return bundle.getBoolean(PreventIntent.KEY_OPTIMIZE_VPN, false);
    }
