...
public class SafeActionUtils {
    ...
    private static final Set<ComponentName> SAFE_CONTENT_PROVIDERS = new HashSet<ComponentName>();
    ...
    static {
        ...
        SAFE_CONTENT_PROVIDERS.add(new ComponentName("com.tencent.mm", "com.tencent.mm.plugin.base.stub.MMPluginProvider"));
    }
    ...
    public static boolean isSafeContentProvider(ComponentName component) {
        ...
        return SAFE_CONTENT_PROVIDERS.contains(component) || SystemHook.isSystemPackage(packageName);
    }
